...
FlowRouter.route('/selectproject',{
    name:'selectproject',
    action(){
        BlazeLayout.render('App_body', {main: 'selectproject'})
    }
});

FlowRouter.route('/planning/:id',{
    name:'startplanning', action(){
        BlazeLayout.render('App_body', {main:'startplanning'})
    }
});
